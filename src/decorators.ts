...
import {sLocalStoreChannelName} from './index'
import {ILocalStoreOptions} from './type'
import {findLocalStoreName, setModule} from './util'

// eslint-disable-next-line func-style
export function LocalStore(_store: any, options: ILocalStoreOptions = {}): any {
  ...
  return function(target: any, key: string) {
    ...
    Object.defineProperty(target, 'beforeCreate', {
      // tslint:disable-next-line
      value: function() {
        setModule.call(this, _store, key, options)
...
export const LocalState = decoratorFactory(function(target, key, option) {
  Object.defineProperty(target, key, {
    // tslint:disable-next-line
    get: localStateFactory(key, option)
  })
})
...
export const LocalMutation = decoratorFactory(function(target, key, option) {
  Object.defineProperty(target, key, {
    // tslint:disable-next-line
    value: localMutationFactory(key, option)
  })
})
...
export const LocalAction = decoratorFactory(function(target, key, option) {
  Object.defineProperty(target, key, {
    // tslint:disable-next-line
    value: localActionFactory(key, option),
  })
})
// eslint-disable-next-line func-style
...
export const LocalGetter = decoratorFactory(function(target, key, option) {
  Object.defineProperty(target, key, {
    // tslint:disable-next-line
    get: localGetterFactory(key, option)
  })
})
